...
public class OpenGamesWindow extends JFrame {
    ...
    public OpenGamesWindow(int userId) {
        ...
        joinButton.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                ...
                String result = WSClient.joinGame(userId, gameId);
                if (result.equals("1")) {
                    JOptionPane.showMessageDialog(this, "Joined game " + gameId + " successfully!");
                    dispose();
                    // Person B will handle opening game board
                } else {
                    JOptionPane.showMessageDialog(this, "Failed to join game", "Error", JOptionPane.ERROR_MESSAGE);
                }
            } else {
    ...
    private void refreshTable() {
        ...
        String data = WSClient.showOpenGames();
